...
def convert_to_mp3(video_file, output_file='output.mp3'):
    """
...
def compressSize(input_file, output_file='compressed.mp4', bitrate='0.5M'):
    """
...
def changeResolution(input_file, w, h, output_file='newResolution.mp4'):
    """
...
def changeAspectRatio(input_file, aspect_ratio, output_file='newAspectRatio.mp4'):
    """
...
def convert_to_GIF(input_file, start_time, duration, output_file='output.gif', format='gif'):
    """
...
def change_speed(input_file, speed_factor, output_file='newSpeed.mp4'):
    """
    ...
    """
    # Adjust the video and audio speed
